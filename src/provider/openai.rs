...
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(untagged)]
enum ChatCompletionRequestMessageContent {
    Text(String),
...
enum ChatCompletionRequestMessageContentPart {
    Text {
        text: String,
    },
    ImageUrl {
...
#[derive(Serialize, Deserialize, Debug, Clone)]
struct ChatCompletionRequestMessageContentPartImageUrl {
...
#[derive(Serialize, Deserialize, Debug, Clone)]
#[serde(untagged)]
enum ChatCompletionFunctionCallOption {
    String(String),
...
#[derive(Serialize, Deserialize, Debug, Clone)]
struct ChatCompletionFunctionCallOptionObject {
    /// Name of the function to call
    pub name: String,
}
...
#[derive(Serialize, Deserialize, Debug, Clone)]
struct ChatCompletionChoiceLogprobs {
...
impl From<crate::provider::types::ChatRequest> for CreateChatCompletionRequest {
    fn from(req: crate::provider::types::ChatRequest) -> Self {
        ...
        CreateChatCompletionRequest {
            ...
            logit_bias: req
                .logit_bias
                .map(|bias| bias.into_iter().map(|(k, v)| (k, v as i32)).collect()),
